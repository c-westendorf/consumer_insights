// Data for "What's changing in our customer base?" question
// Focus: Trend analysis + Customer flow
// Ordering: By magnitude of change (customer count delta, biggest shifts first)
...
window.insightData = {
  ...
  "narrative_focus": "changing",
  "narrative_opening": "The customer base is undergoing significant compositional change: <strong>+89K FS-only customers</strong> represents the largest customer inflow, while <strong>+45K PCW customers</strong> shows growing integrated engagement. However, <strong>-8K retail-only churn</strong> indicates single-channel customers are less sticky. Net trend: customers are joining via retail but the most valuable convert to PCW over time.",
  "recommendations": [
    "Understand drivers: What's causing the FS-only customer acquisition surge (+89K)? New store openings, promotions, or market dynamics?",
    "Optimize conversion funnel: How quickly can we convert new FS-only customers to PCW status? What's the current conversion rate and timeline?",
    "Track lifecycle flow: Monitor the FS → PCW conversion funnel closely. Are we losing customers before conversion happens?",
    "Geographic analysis: Where is FS customer growth concentrated? Does it correlate with pharmacy capacity to absorb conversion?"
  ],
  "maturity_tiers": {
    "PCW Customers": {
      "Active": [
